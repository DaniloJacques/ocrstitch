# Criando o módulo de geração de Excel
excel_generator_code = '''
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
# Salva o código
with open('excel_generator.py', 'w', encoding='utf-8') as f:
    f.write(excel_generator_code)

print("✅ Arquivo 'excel_generator.py' criado com sucesso!")
print("📊 Módulo de geração de Excel criado com:")
print("   - Múltiplas abas (Resumo, Detalhes, PowerAutomate)")
print("   - Formatação profissional")
print("   - Geração de CSV para Power Automate")
